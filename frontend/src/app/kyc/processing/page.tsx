...
export default function KYCProcessingPage() {
  ...
  if (isLoading) {
    return (
      <LoginGated requireSIWE={true}>
        ...
        >
          <div className="bg-white rounded-3xl border border-black p-[64px] max-w-4xl mx-4">
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Retrieving your protected documents
              </p>
            </div>
          </div>
        </div>
  ...
  return (
    <LoginGated requireSIWE={true}>
      <div className="min-h-screen py-12" style={{ background: "#FAF7ED" }}>
        <div className="bg-white rounded-3xl border border-black p-[64px] max-w-6xl mx-auto mx-4">
          {/* Header */}
            ...
            {isCompleted && results && (
              <div className="mt-8 p-6 bg-green-50 border border-green-200 rounded-lg">
                ...
                <p className="text-green-700 mb-4">
                  Your documents have been successfully verified by the iExec
                  KYC app.
                </p>
                ...
                <div className="bg-white p-4 rounded border mb-6">
                  ...
                  <div className="text-sm space-y-1">
                    ...
                    {results.faceMatchScore && (
                      <div>
                        👤 Face Match:{" "}
                        {(results.faceMatchScore * 100).toFixed(1)}%
                      </div>
                    )}
